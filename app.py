...
def main():
    ...
    if add_selectbox == "Online":
        ...
        mutliplelines = st.selectbox("Does the customer have multiple lines",('Yes','No'))
        phoneservice = st.selectbox('Phone Service:', ('Yes', 'No'))
        internetservice = st.selectbox("Does the customer have internet service", ('Fiber optic', 'No'))
